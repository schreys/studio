...
export const CalendarEventSchema = z.object({
  ...
  start: z.object({
    dateTime: z.string().datetime({ message: "Invalid ISO 8601 datetime string for start.dateTime" }).optional().describe('The start date and time of the event (ISO 8601), if it is a timed event.'),
    ...
    dateTime: z.string().datetime({ message: "Invalid ISO 8601 datetime string for end.dateTime" }).optional().describe('The end date and time of the event (ISO 8601), if it is a timed event.'),
